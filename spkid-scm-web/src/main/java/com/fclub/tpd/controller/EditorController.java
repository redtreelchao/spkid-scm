...
public class EditorController {
    ...
    public String upload(@RequestParam("imgFile") MultipartFile imgFile, HttpServletRequest request) throws FileUploadException, IllegalStateException, IOException {
		//文件保存目录路径
	...
	private String getEditorUploadPath() {
		String path = ConstantsHelper.getFckeditorUploadPath() + "/" + getLoginProviderId() + "/";
	...
	private String getEditorVisitPath() {
		return ConstantsHelper.getFckeditorViewPath() + "/" + getLoginProviderId() + "/";
	}
	
	private Integer getLoginProviderId() {
		return SessionHelper.getProvider().getProviderId();
	}
